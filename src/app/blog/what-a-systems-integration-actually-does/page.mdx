...
export const article = {
  date: '2026-06-24',
  title: 'What a systems integration actually does',
  description:
    'A practical explanation of what a systems integration does, when connecting business software is worth the cost, and what to ask before a project starts.',
  author: {
    name: 'Travis Hayes',
    role: 'Founder',
...
If you want help figuring out whether the math works for your systems, [tell me what your team is doing by hand](/contact).
